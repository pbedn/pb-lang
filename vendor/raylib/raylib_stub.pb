...
def SetWindowIcons(images: Image, count: int) -> None: ...
...
def SetShaderValue(shader: Shader, locIndex: int, value: None, uniformType: int) -> None: ...
def SetShaderValueV(shader: Shader, locIndex: int, value: None, uniformType: int, count: int) -> None: ...
...
def TraceLog(logLevel: int, text: str) -> None: ...
def SetTraceLogLevel(logLevel: int) -> None: ...
def MemFree(ptr: None) -> None: ...
def UnloadFileData(data: int) -> None: ...
def SaveFileData(fileName: str, data: None, dataSize: int) -> bool: ...
...
def SetAutomationEventList(list: AutomationEventList) -> None: ...
...
def UpdateCamera(camera: Camera, mode: int) -> None: ...
def UpdateCameraPro(camera: Camera, movement: Vector3, rotation: Vector3, zoom: float) -> None: ...
...
def DrawLineStrip(points: Vector2, pointCount: int, color: Color) -> None: ...
...
def DrawTriangleFan(points: Vector2, pointCount: int, color: Color) -> None: ...
def DrawTriangleStrip(points: Vector2, pointCount: int, color: Color) -> None: ...
...
def DrawSplineLinear(points: Vector2, pointCount: int, thick: float, color: Color) -> None: ...
def DrawSplineBasis(points: Vector2, pointCount: int, thick: float, color: Color) -> None: ...
def DrawSplineCatmullRom(points: Vector2, pointCount: int, thick: float, color: Color) -> None: ...
def DrawSplineBezierQuadratic(points: Vector2, pointCount: int, thick: float, color: Color) -> None: ...
def DrawSplineBezierCubic(points: Vector2, pointCount: int, thick: float, color: Color) -> None: ...
...
def CheckCollisionPointPoly(point: Vector2, points: Vector2, pointCount: int) -> bool: ...
def CheckCollisionLines(startPos1: Vector2, endPos1: Vector2, startPos2: Vector2, endPos2: Vector2, collisionPoint: Vector2) -> bool: ...
...
def ImageFormat(image: Image, newFormat: int) -> None: ...
def ImageToPOT(image: Image, fill: Color) -> None: ...
def ImageCrop(image: Image, crop: Rectangle) -> None: ...
def ImageAlphaCrop(image: Image, threshold: float) -> None: ...
def ImageAlphaClear(image: Image, color: Color, threshold: float) -> None: ...
def ImageAlphaMask(image: Image, alphaMask: Image) -> None: ...
def ImageAlphaPremultiply(image: Image) -> None: ...
def ImageBlurGaussian(image: Image, blurSize: int) -> None: ...
def ImageKernelConvolution(image: Image, kernel: float, kernelSize: int) -> None: ...
def ImageResize(image: Image, newWidth: int, newHeight: int) -> None: ...
def ImageResizeNN(image: Image, newWidth: int, newHeight: int) -> None: ...
def ImageResizeCanvas(image: Image, newWidth: int, newHeight: int, offsetX: int, offsetY: int, fill: Color) -> None: ...
def ImageMipmaps(image: Image) -> None: ...
def ImageDither(image: Image, rBpp: int, gBpp: int, bBpp: int, aBpp: int) -> None: ...
def ImageFlipVertical(image: Image) -> None: ...
def ImageFlipHorizontal(image: Image) -> None: ...
def ImageRotate(image: Image, degrees: int) -> None: ...
def ImageRotateCW(image: Image) -> None: ...
def ImageRotateCCW(image: Image) -> None: ...
def ImageColorTint(image: Image, color: Color) -> None: ...
def ImageColorInvert(image: Image) -> None: ...
def ImageColorGrayscale(image: Image) -> None: ...
def ImageColorContrast(image: Image, contrast: float) -> None: ...
def ImageColorBrightness(image: Image, brightness: int) -> None: ...
def ImageColorReplace(image: Image, color: Color, replace: Color) -> None: ...
def UnloadImageColors(colors: Color) -> None: ...
def UnloadImagePalette(colors: Color) -> None: ...
def GetImageAlphaBorder(image: Image, threshold: float) -> Rectangle: ...
def GetImageColor(image: Image, x: int, y: int) -> Color: ...
def ImageClearBackground(dst: Image, color: Color) -> None: ...
def ImageDrawPixel(dst: Image, posX: int, posY: int, color: Color) -> None: ...
def ImageDrawPixelV(dst: Image, position: Vector2, color: Color) -> None: ...
def ImageDrawLine(dst: Image, startPosX: int, startPosY: int, endPosX: int, endPosY: int, color: Color) -> None: ...
def ImageDrawLineV(dst: Image, start: Vector2, end: Vector2, color: Color) -> None: ...
def ImageDrawLineEx(dst: Image, start: Vector2, end: Vector2, thick: int, color: Color) -> None: ...
def ImageDrawCircle(dst: Image, centerX: int, centerY: int, radius: int, color: Color) -> None: ...
def ImageDrawCircleV(dst: Image, center: Vector2, radius: int, color: Color) -> None: ...
def ImageDrawCircleLines(dst: Image, centerX: int, centerY: int, radius: int, color: Color) -> None: ...
def ImageDrawCircleLinesV(dst: Image, center: Vector2, radius: int, color: Color) -> None: ...
def ImageDrawRectangle(dst: Image, posX: int, posY: int, width: int, height: int, color: Color) -> None: ...
def ImageDrawRectangleV(dst: Image, position: Vector2, size: Vector2, color: Color) -> None: ...
def ImageDrawRectangleRec(dst: Image, rec: Rectangle, color: Color) -> None: ...
def ImageDrawRectangleLines(dst: Image, rec: Rectangle, thick: int, color: Color) -> None: ...
def ImageDrawTriangle(dst: Image, v1: Vector2, v2: Vector2, v3: Vector2, color: Color) -> None: ...
def ImageDrawTriangleEx(dst: Image, v1: Vector2, v2: Vector2, v3: Vector2, c1: Color, c2: Color, c3: Color) -> None: ...
def ImageDrawTriangleLines(dst: Image, v1: Vector2, v2: Vector2, v3: Vector2, color: Color) -> None: ...
def ImageDrawTriangleFan(dst: Image, points: Vector2, pointCount: int, color: Color) -> None: ...
def ImageDrawTriangleStrip(dst: Image, points: Vector2, pointCount: int, color: Color) -> None: ...
def ImageDraw(dst: Image, src: Image, srcRec: Rectangle, dstRec: Rectangle, tint: Color) -> None: ...
def ImageDrawText(dst: Image, text: str, posX: int, posY: int, fontSize: int, color: Color) -> None: ...
def ImageDrawTextEx(dst: Image, font: Font, text: str, position: Vector2, fontSize: float, spacing: float, tint: Color) -> None: ...
...
def UpdateTexture(texture: Texture2D, pixels: None) -> None: ...
def UpdateTextureRec(texture: Texture2D, rec: Rectangle, pixels: None) -> None: ...
def GenTextureMipmaps(texture: Texture2D) -> None: ...
...
def GetPixelColor(srcPtr: None, format: int) -> Color: ...
def SetPixelColor(dstPtr: None, color: Color, format: int) -> None: ...
...
def GenImageFontAtlas(glyphs: GlyphInfo, glyphRecs: Rectangle, glyphCount: int, fontSize: int, padding: int, packMethod: int) -> Image: ...
def UnloadFontData(glyphs: GlyphInfo, glyphCount: int) -> None: ...
...
def DrawTriangleStrip3D(points: Vector3, pointCount: int, color: Color) -> None: ...
...
def UploadMesh(mesh: Mesh, dynamic: bool) -> None: ...
def UpdateMeshBuffer(mesh: Mesh, index: int, data: None, dataSize: int, offset: int) -> None: ...
def UnloadMesh(mesh: Mesh) -> None: ...
def DrawMesh(mesh: Mesh, material: Material, transform: Matrix) -> None: ...
def DrawMeshInstanced(mesh: Mesh, material: Material, transforms: Matrix, instances: int) -> None: ...
def GetMeshBoundingBox(mesh: Mesh) -> BoundingBox: ...
def GenMeshTangents(mesh: Mesh) -> None: ...
...
def SetMaterialTexture(material: Material, mapType: int, texture: Texture2D) -> None: ...
def SetModelMeshMaterial(model: Model, meshId: int, materialId: int) -> None: ...
...
def UnloadModelAnimations(animations: ModelAnimation, animCount: int) -> None: ...
...
def UpdateSound(sound: Sound, data: None, sampleCount: int) -> None: ...
...
def WaveCrop(wave: Wave, initFrame: int, finalFrame: int) -> None: ...
def WaveFormat(wave: Wave, sampleRate: int, sampleSize: int, channels: int) -> None: ...
def UnloadWaveSamples(samples: float) -> None: ...
...
def UpdateAudioStream(stream: AudioStream, data: None, frameCount: int) -> None: ...
