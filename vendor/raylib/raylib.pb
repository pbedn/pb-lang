...
def LoadImageAnimFromMemory(fileType: str, fileData: str, dataSize: int, frames: int) -> Image: ...
...
def LoadFontFromMemory(fileType: str, fileData: str, dataSize: int, fontSize: int, codepoints: int, codepointCount: int) -> Font: ...
